...
export const ATC_CONFIG = {
  ...
  SIMULATOR: {
    ...
    STREAM_RECONNECT_MS: getEnvOrLocal('VITE_STREAM_RECONNECT_MS', 5000),
    STREAM_FLUSH_THROTTLE_MS: getEnvOrLocal('VITE_STREAM_FLUSH_THROTTLE_MS', 100),
    AUTO_ANALYZE_DELAY_MS: getEnvOrLocal('VITE_AUTO_ANALYZE_DELAY_MS', 500),
    BASE_URL: '/api',
